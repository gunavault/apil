...
class PabrikController extends Controller{
    ...
    public function index($kode_plasma)
    {
        ...
        if ($kode_plasma != 'all' && $kode_plasma != NULL){
            $pabrik = Pabrik::where('plasma', $kode_plasma)->where('keterangan', 'inti')->get();
            $trip_new = SortasiPlasma::where('status', '2')->where('kode_plasma', $kode_plasma)->where('tanggal', $tanggal)->take(10)->orderBy('masuk', 'asc')->get();
            $nettoToday = SortasiPlasma::whereBetween('status', ['1', '2'])->where('kode_plasma', $kode_plasma)->where('tanggal', $tanggal)->sum('netto');
            $nettoLastDay = SortasiPlasma::whereBetween('status', ['1', '2'])->where('kode_plasma', $kode_plasma)->where('tanggal', $lastday)->sum('netto');
            $tripToday = SortasiPlasma::where('tanggal', $tanggal)->where('kode_plasma', $kode_plasma)->whereBetween('status', ['1', '2'])->count();
            $tripUpper5 = SortasiPlasma::where('tanggal', $tanggal)->where('kode_plasma', $kode_plasma)->where('potongan','>=','5')->count();
            $tripCancel = SortasiPlasma::where('tanggal', $tanggal)->where('kode_plasma', $kode_plasma)->where('status', '5')->count();

        }
        if ($kode_plasma == 'all'){
            $pabrik = Pabrik::where('keterangan', 'inti')->get();
    ...
    public function home($kode_plasma)
    {
        $defaultbulan = array(
            '01'=>"Januari",
            '02'=>"Februari",
        ...
        if ($kode_plasma!='all' && $kode_plasma != NULL){
            $tonaseThisDay = SortasiPlasma::where('kode_plasma', $kode_plasma)->whereBetween('status', ['1', '2'])
                ->Where('tanggal', '=',date('Y-m-d'))
                ->sum('netto');

            $tonaseThisMonth = SortasiPlasma::where('kode_plasma', $kode_plasma)->whereBetween('status', ['1', '2'])
                ->WhereMonth('tanggal', '=',date('m'))
                ->whereYear('tanggal', '=',date('Y'))
                ->sum('netto');

            $tonaseTillThisMonth = SortasiPlasma::where('kode_plasma', $kode_plasma)->whereBetween('status', ['1', '2'])
                ->WhereMonth('tanggal', '<=',date('m'))
                ->whereYear('tanggal', '=',date('Y'))
                ->sum('netto');

            $tripThisMonth = SortasiPlasma::where('kode_plasma', $kode_plasma)->whereBetween('status', ['1', '2'])
                ->WhereMonth('tanggal', '=',date('m'))
                ->whereYear('tanggal', '=',date('Y'))
                ->count();

            $tripThisDay = SortasiPlasma::where('kode_plasma', $kode_plasma)->whereBetween('status', ['1', '2'])
                ->Where('tanggal', '=',date('Y-m-d'))
                ->count();

            $tripTillThisMonth = SortasiPlasma::where('kode_plasma', $kode_plasma)->whereBetween('status', ['1', '2'])
                ->WhereMonth('tanggal', '<=',date('m'))
                ->whereYear('tanggal', '=',date('Y'))
                ->count();

            $tripPotonganThisDay = SortasiPlasma::where('kode_plasma', $kode_plasma)->where('status','>=', '5')
                ->Where('tanggal', '=',date('Y-m-d'))
                ->count();

            $tripPotonganThisMonth = SortasiPlasma::where('kode_plasma', $kode_plasma)->where('status','>=', '5')
                ->WhereMonth('tanggal', '=',date('m'))
                ->whereYear('tanggal', '=',date('Y'))
                ->count();

            $tripPotonganTillThisMonth = SortasiPlasma::where('kode_plasma', $kode_plasma)->where('status','>=', '5')
                ->WhereMonth('tanggal', '<=',date('m'))
                ->whereYear('tanggal', '=',date('Y'))
                ->count();

            $tonasePerMonth = SortasiPlasma::where('kode_plasma', $kode_plasma)->whereBetween('status', ['1', '2'])
                ->WhereMonth('tanggal', '<=',date('m'))
                ->whereYear('tanggal', '=',date('Y'))
            ...
            $topTrip = SortasiPlasma::where('kode_plasma', $kode_plasma)->whereBetween('status', ['1', '2'])
                ->WhereMonth('tanggal', '=',date('m'))
                ->whereYear('tanggal', '=',date('Y'))
            ...
            $kode_kebun = SortasiPlasma::selectRaw("kode_kebun")->where('kode_plasma', $kode_plasma)
